...
const ScraperRow = (props: {
    ...
    const onSelectorDelete = (selectorToDelete: string) => {
        console.log(selectorToDelete, selectors);
        setSelectors((selectors) => selectors.filter((selector) => selector !== selectorToDelete))
    }
                                    ...
                                    <><InputLabel required htmlFor="selectors"
                                        ...
                                        <FormControl fullWidth>
                                            <Paper id='selectors'
                                                ...
                                                {row.selectors.map((selector: string, index) => {
                                                    return (
                                                        <Chip
                                                            key={selector + index}
                                                            sx={{m: '3px'}}
