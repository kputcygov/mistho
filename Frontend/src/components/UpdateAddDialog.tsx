...
export const UpdateAddDialog = ({
  ...
  open: boolean;
  onClose: (scraperToUpdate: ScrapersEntity) => void;
  id?: string;
}) => {
  ...
  const updateValue = (
    ...
    scraperToUpdateParam: ScrapersEntity
  ) => {
